...
#define STASH_RECIRCULATE(flag) { \
	...
	bool bool3 = ch_third_stash_counter_read >= STASH_RECIRCULATION_THRESHOLD;\
	bool bool4 = ch_fourth_stash_counter_read >= STASH_RECIRCULATION_THRESHOLD;\
	bool bool5 = ch_first_stash_counter_read >= STASH_LENGTH;\
	bool bool6 = ch_second_stash_counter_read >= STASH_LENGTH;\
	bool bool7 = ch_third_stash_counter_read >= STASH_LENGTH;\
	bool bool8 = ch_fourth_stash_counter_read >= STASH_LENGTH;\
	bool bool9 = bool1 && bool2 && bool3 && bool4; \
	bool bool10 = bool5 || bool6 || bool7 || bool8;\
	bool bool11 = bool9 || bool10;\
	if (flag == 1) { \
	...
	apply {
		...
		if (standard_metadata.instance_type != PKT_INSTANCE_TYPE_RESUBMIT) {
			...
			if (datapath_selection_index == 0) {
				...
				READ_FROM_CUCKOO_ALGO(10w0 ++ packet_key, CH_FIRST_HASH_KEY, ch_first_level_third_table, CH_LENGTH_BIT, first_result, CH_FIRST_HASH_REVERSE, crc16); 
				READ_FROM_CUCKOO_ALGO(10w0 ++ packet_key, CH_SECOND_HASH_KEY, ch_second_level_third_table, CH_LENGTH_BIT, second_result, CH_SECOND_HASH_REVERSE, crc32); 
				...
				READ_FROM_CUCKOO_ALGO(10w0 ++ packet_key, CH_FIRST_HASH_KEY, ch_first_level_fourth_table, CH_LENGTH_BIT, first_result, CH_FIRST_HASH_REVERSE, crc16); 
				READ_FROM_CUCKOO_ALGO(10w0 ++ packet_key, CH_SECOND_HASH_KEY, ch_second_level_fourth_table, CH_LENGTH_BIT, second_result, CH_SECOND_HASH_REVERSE, crc32); 
			...
			if (find_in_first) {
				...
				if (datapath_selection_index == 0) {
					...
					INSERT_INTO_CUCKOO_ALGO(10w0 ++ packet_key, CH_FIRST_HASH_KEY, ch_first_level_third_table, CH_LENGTH_BIT, temp, CH_FIRST_HASH_REVERSE, crc16);
				} else {
				...
				if (datapath_selection_index == 0) {
					...
					INSERT_INTO_CUCKOO_ALGO(10w0 ++ packet_key, CH_SECOND_HASH_KEY, ch_second_level_third_table, CH_LENGTH_BIT, temp, CH_SECOND_HASH_REVERSE, crc32);
				} else {
			...
			INSERT_INTO_CUCKOO_ALGO(ch_third_stash_read, CH_FIRST_HASH_KEY, ch_first_level_third_table, CH_LENGTH_BIT, ch_first_level_third_table_read, CH_FIRST_HASH_REVERSE, crc16);
			INSERT_INTO_CUCKOO_ALGO(ch_fourth_stash_read, CH_FIRST_HASH_KEY, ch_first_level_fourth_table, CH_LENGTH_BIT, ch_first_level_fourth_table_read, CH_FIRST_HASH_REVERSE, crc16);
			...
			INSERT_INTO_CUCKOO_ALGO(ch_first_level_third_table_read, CH_SECOND_HASH_KEY, ch_second_level_third_table, CH_LENGTH_BIT, ch_second_level_third_table_read, CH_SECOND_HASH_REVERSE, crc32);
			INSERT_INTO_CUCKOO_ALGO(ch_first_level_fourth_table_read, CH_SECOND_HASH_KEY, ch_second_level_fourth_table, CH_LENGTH_BIT, ch_second_level_fourth_table_read, CH_SECOND_HASH_REVERSE, crc32);
