...
#define PIBLT_INPUT_WIDTH  (HASH_OUTPUT_WIDTH*4+TABLES_KEY_INPUT_WIDTH)

// key used to contain two index 
#define BASELINE_ARRAY_INPUT_WIDTH (TABLES_KEY_INPUT_WIDTH + TABLES_VALUE_INPUT_WIDTH)
#define BASELINE_ARRAY_OUTPUT_WIDTH (TABLES_VALUE_INPUT_WIDTH)
