...
control MyIngress(inout headers hdr,
	...
	apply {
		...
		bit<HASH_KEY_INPUT_WIDTH> hasher_key = 64w0 ++ hdr.tcp.dstPort ++ hdr.tcp.srcPort ++ hdr.ipv4.dstAddr;
		hasher_input = hasher_prefix ++ hasher_key;
		bit<HASH_OUTPUT_WIDTH> hasher_output;
		// compute hash
		hasher_extern.apply(hasher_input, hasher_output);
		meta.axis_tuser[TABLES_KEY_INPUT_WIDTH+31:TABLES_KEY_INPUT_WIDTH] = 32w5;	
		//TODO: count things, bitwise map
	}
}
